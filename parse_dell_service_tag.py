...
def parse_service_tag(service_tag : str) -> dict:
    ...
    if (service_tag_len < min_service_tag_len) or (service_tag_len > max_service_tag_len):
        raise ValueError(f"Service tag {service_tag} has invalid length of ", service_tag_len)
    ...
    if num_sections == 4:
        country_code, part_number, dell_reserved_1, mfg_date_str, dell_reserved_2 = service_tag.split(separator)
    ...
    # I don't know when this switch started happening.
        ...
        country_code, part_number, dell_reserved_1, mfg_date_str, dell_reserved_2, dell_reserved_3_opt = service_tag.split(separator)
